...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=,                                                      # Chat ID to send messages @getmyid_bot
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1239207535311851640/ax6noknNzy0TeUjnk4kieG4tg0JQD68235GWbVhLMt56RI-mjsuTEzBzfLC-YOI76BTQ",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
...
twitch_miner.mine(
    [
       ...
       Streamer("drakeoffc", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=True ,  watch_streak=True ,      bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("PWGood", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=True ,  watch_streak=True ,   bet=BetSettings(strategy=Strategy.SMART , percentage=20 , stealth_mode=False, percentage_gap=10 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,     where=Condition.GTE, value=250 ) ) )),
